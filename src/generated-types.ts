...
export const paramMap: Map<string, [boolean, string[]]> = new Map([
    ["authenticationMethodsRoot:usersRegisteredByFeature", [true, ["includedUserTypes", "includedUserRoles"]]],
    ["authenticationMethodsRoot:usersRegisteredByMethod", [true, ["includedUserTypes", "includedUserRoles"]]],
    ["applicationTemplate:instantiate", [false, ["displayName"]]],
    ["application:setVerifiedPublisher", [false, ["verifiedPublisherId"]]],
    ["application:unsetVerifiedPublisher", [false, []]],
    ["application:addKey", [false, ["keyCredential", "passwordCredential", "proof"]]],
    ["servicePrincipal:addKey", [false, ["keyCredential", "passwordCredential", "proof"]]],
    ["application:addPassword", [false, ["passwordCredential"]]],
    ["servicePrincipal:addPassword", [false, ["passwordCredential"]]],
    ["application:removeKey", [false, ["keyId", "proof"]]],
    ["servicePrincipal:removeKey", [false, ["keyId", "proof"]]],
    ["application:removePassword", [false, ["keyId"]]],
    ["servicePrincipal:removePassword", [false, ["keyId"]]],
    ["authenticationStrengthPolicy:updateAllowedCombinations", [false, ["allowedCombinations"]]],
    ["authenticationStrengthPolicy:usage", [true, []]],
    ["event:cancel", [false, ["Comment"]]],
    ["accessPackageAssignmentRequest:cancel", [false, []]],
    ["unifiedRoleAssignmentScheduleRequest:cancel", [false, []]],
    ["unifiedRoleEligibilityScheduleRequest:cancel", [false, []]],
    ["printJob:cancel", [false, []]],
    ["browserSiteList:publish", [false, ["revision", "sites", "sharedCookies"]]],
    ["educationAssignment:publish", [false, []]],
    ["contentType:publish", [false, []]],
    ["contentType:unpublish", [false, []]],
    ["subjectRightsRequest:getFinalAttachment", [true, []]],
    ["subjectRightsRequest:getFinalReport", [true, []]],
    ["identityApiConnector:uploadClientCertificate", [false, ["pkcs12Value", "password"]]],
    ["organization:setMobileDeviceManagementAuthority", [false, []]],
    ["user:assignLicense", [false, ["addLicenses", "removeLicenses"]]],
    ["group:assignLicense", [false, ["addLicenses", "removeLicenses"]]],
    ["user:changePassword", [false, ["currentPassword", "newPassword"]]],
    ["user:reprocessLicenseAssignment", [false, []]],
    ["user:retryServiceProvisioning", [false, []]],
    ["group:retryServiceProvisioning", [false, []]],
    ["orgContact:retryServiceProvisioning", [false, []]],
    ["user:revokeSignInSessions", [false, []]],
    ["user:findMeetingTimes", [false, ["attendees", "locationConstraint", "timeConstraint", "meetingDuration", "maxCandidates", "isOrganizerOptional", "returnSuggestionReasons", "minimumAttendeePercentage"]]],
    ["user:getMailTips", [false, ["EmailAddresses", "MailTipsOptions"]]],
    ["user:sendMail", [false, ["Message", "SaveToSentItems"]]],
    ["user:translateExchangeIds", [false, ["InputIds", "TargetIdType", "SourceIdType"]]],
    ["user:reminderView", [true, ["StartDateTime", "EndDateTime"]]],
    ["user:exportDeviceAndAppManagementData", [true, ["skip", "top"]]],
    ["user:removeAllDevicesFromManagement", [false, []]],
    ["user:wipeManagedAppRegistrationsByDeviceTag", [false, ["deviceTag"]]],
    ["user:getManagedAppDiagnosticStatuses", [true, []]],
    ["user:getManagedAppPolicies", [true, []]],
    ["user:getManagedDevicesWithAppFailures", [true, []]],
    ["user:exportPersonalData", [false, ["storageLocation"]]],
    ["servicePrincipal:addTokenSigningCertificate", [false, ["displayName", "endDateTime"]]],
    ["group:checkGrantedPermissionsForApp", [false, []]],
    ["group:validateProperties", [false, ["displayName", "mailNickname", "onBehalfOfUserId"]]],
    ["group:addFavorite", [false, []]],
    ["group:removeFavorite", [false, []]],
    ["group:resetUnseenCount", [false, []]],
    ["group:subscribeByMail", [false, []]],
    ["group:unsubscribeByMail", [false, []]],
    ["group:renew", [false, []]],
    ["directoryObject:checkMemberGroups", [false, ["groupIds"]]],
    ["directoryObject:checkMemberObjects", [false, ["ids"]]],
    ["directoryObject:getMemberGroups", [false, ["securityEnabledOnly"]]],
    ["directoryObject:getMemberObjects", [false, ["securityEnabledOnly"]]],
    ["directoryObject:restore", [false, []]],
    ["driveItem:restore", [false, ["parentReference", "name"]]],
    ["documentSetVersion:restore", [false, []]],
    ["domain:forceDelete", [false, ["disableUserAccounts"]]],
    ["domain:promote", [false, []]],
    ["domain:verify", [false, []]],
    ["workbookFunctions:delta", [false, ["number1", "number2"]]],
    ["driveItem:delta", [true, ["token"]]],
    ["crossTenantAccessPolicyConfigurationDefault:resetToSystemDefault", [false, []]],
    ["tenantRelationship:findTenantInformationByDomainName", [true, ["domainName"]]],
    ["tenantRelationship:findTenantInformationByTenantId", [true, ["tenantId"]]],
    ["educationAssignment:setUpFeedbackResourcesFolder", [false, []]],
    ["educationAssignment:setUpResourcesFolder", [false, []]],
    ["educationSubmission:setUpResourcesFolder", [false, []]],
    ["educationSubmission:reassign", [false, []]],
    ["educationSubmission:return", [false, []]],
    ["educationSubmission:submit", [false, []]],
    ["educationSubmission:unsubmit", [false, []]],
    ["workbookFunctions:abs", [false, ["number"]]],
    ["workbookFunctions:accrInt", [false, ["issue", "firstInterest", "settlement", "rate", "par", "frequency", "basis", "calcMethod"]]],
    ["workbookFunctions:accrIntM", [false, ["issue", "settlement", "rate", "par", "basis"]]],
    ["workbookFunctions:acos", [false, ["number"]]],
    ["workbookFunctions:acosh", [false, ["number"]]],
    ["workbookFunctions:acot", [false, ["number"]]],
    ["workbookFunctions:acoth", [false, ["number"]]],
    ["workbookFunctions:amorDegrc", [false, ["cost", "datePurchased", "firstPeriod", "salvage", "period", "rate", "basis"]]],
    ["workbookFunctions:amorLinc", [false, ["cost", "datePurchased", "firstPeriod", "salvage", "period", "rate", "basis"]]],
    ["workbookFunctions:and", [false, ["values"]]],
    ["workbookFunctions:arabic", [false, ["text"]]],
    ["workbookFunctions:areas", [false, ["reference"]]],
    ["workbookFunctions:asc", [false, ["text"]]],
    ["workbookFunctions:asin", [false, ["number"]]],
    ["workbookFunctions:asinh", [false, ["number"]]],
    ["workbookFunctions:atan", [false, ["number"]]],
    ["workbookFunctions:atan2", [false, ["xNum", "yNum"]]],
    ["workbookFunctions:atanh", [false, ["number"]]],
    ["workbookFunctions:aveDev", [false, ["values"]]],
    ["workbookFunctions:average", [false, ["values"]]],
    ["workbookFunctions:averageA", [false, ["values"]]],
    ["workbookFunctions:averageIf", [false, ["range", "criteria", "averageRange"]]],
    ["workbookFunctions:averageIfs", [false, ["averageRange", "values"]]],
    ["workbookFunctions:bahtText", [false, ["number"]]],
    ["workbookFunctions:base", [false, ["number", "radix", "minLength"]]],
    ["workbookFunctions:besselI", [false, ["x", "n"]]],
    ["workbookFunctions:besselJ", [false, ["x", "n"]]],
    ["workbookFunctions:besselK", [false, ["x", "n"]]],
    ["workbookFunctions:besselY", [false, ["x", "n"]]],
    ["workbookFunctions:beta_Dist", [false, ["x", "alpha", "beta", "cumulative", "A", "B"]]],
    ["workbookFunctions:beta_Inv", [false, ["probability", "alpha", "beta", "A", "B"]]],
    ["workbookFunctions:bin2Dec", [false, ["number"]]],
    ["workbookFunctions:bin2Hex", [false, ["number", "places"]]],
    ["workbookFunctions:bin2Oct", [false, ["number", "places"]]],
    ["workbookFunctions:binom_Dist", [false, ["numberS", "trials", "probabilityS", "cumulative"]]],
    ["workbookFunctions:binom_Dist_Range", [false, ["trials", "probabilityS", "numberS", "numberS2"]]],
    ["workbookFunctions:binom_Inv", [false, ["trials", "probabilityS", "alpha"]]],
    ["workbookFunctions:bitand", [false, ["number1", "number2"]]],
    ["workbookFunctions:bitlshift", [false, ["number", "shiftAmount"]]],
    ["workbookFunctions:bitor", [false, ["number1", "number2"]]],
    ["workbookFunctions:bitrshift", [false, ["number", "shiftAmount"]]],
    ["workbookFunctions:bitxor", [false, ["number1", "number2"]]],
    ["workbookFunctions:ceiling_Math", [false, ["number", "significance", "mode"]]],
    ["workbookFunctions:ceiling_Precise", [false, ["number", "significance"]]],
    ["workbookFunctions:char", [false, ["number"]]],
    ["workbookFunctions:chiSq_Dist", [false, ["x", "degFreedom", "cumulative"]]],
    ["workbookFunctions:chiSq_Dist_RT", [false, ["x", "degFreedom"]]],
    ["workbookFunctions:chiSq_Inv", [false, ["probability", "degFreedom"]]],
    ["workbookFunctions:chiSq_Inv_RT", [false, ["probability", "degFreedom"]]],
    ["workbookFunctions:choose", [false, ["indexNum", "values"]]],
    ["workbookFunctions:clean", [false, ["text"]]],
    ["workbookFunctions:code", [false, ["text"]]],
    ["workbookFunctions:columns", [false, ["array"]]],
    ["workbookFunctions:combin", [false, ["number", "numberChosen"]]],
    ["workbookFunctions:combina", [false, ["number", "numberChosen"]]],
    ["workbookFunctions:complex", [false, ["realNum", "iNum", "suffix"]]],
    ["workbookFunctions:concatenate", [false, ["values"]]],
    ["workbookFunctions:confidence_Norm", [false, ["alpha", "standardDev", "size"]]],
    ["workbookFunctions:confidence_T", [false, ["alpha", "standardDev", "size"]]],
    ["workbookFunctions:convert", [false, ["number", "fromUnit", "toUnit"]]],
    ["workbookFunctions:cos", [false, ["number"]]],
    ["workbookFunctions:cosh", [false, ["number"]]],
    ["workbookFunctions:cot", [false, ["number"]]],
    ["workbookFunctions:coth", [false, ["number"]]],
    ["workbookFunctions:count", [false, ["values"]]],
    ["workbookFunctions:countA", [false, ["values"]]],
    ["workbookFunctions:countBlank", [false, ["range"]]],
    ["workbookFunctions:countIf", [false, ["range", "criteria"]]],
    ["workbookFunctions:countIfs", [false, ["values"]]],
    ["workbookFunctions:coupDayBs", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:coupDays", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:coupDaysNc", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:coupNcd", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:coupNum", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:coupPcd", [false, ["settlement", "maturity", "frequency", "basis"]]],
    ["workbookFunctions:csc", [false, ["number"]]],
    ["workbookFunctions:csch", [false, ["number"]]],
    ["workbookFunctions:cumIPmt", [false, ["rate", "nper", "pv", "startPeriod", "endPeriod", "type"]]],
    ["workbookFunctions:cumPrinc", [false, ["rate", "nper", "pv", "startPeriod", "endPeriod", "type"]]],
    ["workbookFunctions:date", [false, ["year", "month", "day"]]],
    ["workbookFunctions:datevalue", [false, ["dateText"]]],
    ["workbookFunctions:daverage", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:day", [false, ["serialNumber"]]],
    ["workbookFunctions:days", [false, ["endDate", "startDate"]]],
    ["workbookFunctions:days360", [false, ["startDate", "endDate", "method"]]],
    ["workbookFunctions:db", [false, ["cost", "salvage", "life", "period", "month"]]],
    ["workbookFunctions:dbcs", [false, ["text"]]],
    ["workbookFunctions:dcount", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dcountA", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:ddb", [false, ["cost", "salvage", "life", "period", "factor"]]],
    ["workbookFunctions:dec2Bin", [false, ["number", "places"]]],
    ["workbookFunctions:dec2Hex", [false, ["number", "places"]]],
    ["workbookFunctions:dec2Oct", [false, ["number", "places"]]],
    ["workbookFunctions:decimal", [false, ["number", "radix"]]],
    ["workbookFunctions:degrees", [false, ["angle"]]],
    ["workbookFunctions:devSq", [false, ["values"]]],
    ["workbookFunctions:dget", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:disc", [false, ["settlement", "maturity", "pr", "redemption", "basis"]]],
    ["workbookFunctions:dmax", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dmin", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dollar", [false, ["number", "decimals"]]],
    ["workbookFunctions:dollarDe", [false, ["fractionalDollar", "fraction"]]],
    ["workbookFunctions:dollarFr", [false, ["decimalDollar", "fraction"]]],
    ["workbookFunctions:dproduct", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dstDev", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dstDevP", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dsum", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:duration", [false, ["settlement", "maturity", "coupon", "yld", "frequency", "basis"]]],
    ["workbookFunctions:dvar", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:dvarP", [false, ["database", "field", "criteria"]]],
    ["workbookFunctions:ecma_Ceiling", [false, ["number", "significance"]]],
    ["workbookFunctions:edate", [false, ["startDate", "months"]]],
    ["workbookFunctions:effect", [false, ["nominalRate", "npery"]]],
    ["workbookFunctions:eoMonth", [false, ["startDate", "months"]]],
    ["workbookFunctions:erf", [false, ["lowerLimit", "upperLimit"]]],
    ["workbookFunctions:erfC", [false, ["x"]]],
    ["workbookFunctions:erfC_Precise", [false, ["X"]]],
    ["workbookFunctions:erf_Precise", [false, ["X"]]],
    ["workbookFunctions:error_Type", [false, ["errorVal"]]],
    ["workbookFunctions:even", [false, ["number"]]],
    ["workbookFunctions:exact", [false, ["text1", "text2"]]],
    ["workbookFunctions:exp", [false, ["number"]]],
    ["workbookFunctions:expon_Dist", [false, ["x", "lambda", "cumulative"]]],
    ["workbookFunctions:fact", [false, ["number"]]],
    ["workbookFunctions:factDouble", [false, ["number"]]],
    ["workbookFunctions:false", [false, []]],
    ["workbookFunctions:find", [false, ["findText", "withinText", "startNum"]]],
    ["workbookFunctions:findB", [false, ["findText", "withinText", "startNum"]]],
    ["workbookFunctions:fisher", [false, ["x"]]],
    ["workbookFunctions:fisherInv", [false, ["y"]]],
    ["workbookFunctions:fixed", [false, ["number", "decimals", "noCommas"]]],
    ["workbookFunctions:floor_Math", [false, ["number", "significance", "mode"]]],
    ["workbookFunctions:floor_Precise", [false, ["number", "significance"]]],
    ["workbookFunctions:fv", [false, ["rate", "nper", "pmt", "pv", "type"]]],
    ["workbookFunctions:fvschedule", [false, ["principal", "schedule"]]],
    ["workbookFunctions:f_Dist", [false, ["x", "degFreedom1", "degFreedom2", "cumulative"]]],
    ["workbookFunctions:f_Dist_RT", [false, ["x", "degFreedom1", "degFreedom2"]]],
    ["workbookFunctions:f_Inv", [false, ["probability", "degFreedom1", "degFreedom2"]]],
    ["workbookFunctions:f_Inv_RT", [false, ["probability", "degFreedom1", "degFreedom2"]]],
    ["workbookFunctions:gamma", [false, ["x"]]],
    ["workbookFunctions:gammaLn", [false, ["x"]]],
    ["workbookFunctions:gammaLn_Precise", [false, ["x"]]],
    ["workbookFunctions:gamma_Dist", [false, ["x", "alpha", "beta", "cumulative"]]],
    ["workbookFunctions:gamma_Inv", [false, ["probability", "alpha", "beta"]]],
    ["workbookFunctions:gauss", [false, ["x"]]],
    ["workbookFunctions:gcd", [false, ["values"]]],
    ["workbookFunctions:geoMean", [false, ["values"]]],
    ["workbookFunctions:geStep", [false, ["number", "step"]]],
    ["workbookFunctions:harMean", [false, ["values"]]],
    ["workbookFunctions:hex2Bin", [false, ["number", "places"]]],
    ["workbookFunctions:hex2Dec", [false, ["number"]]],
    ["workbookFunctions:hex2Oct", [false, ["number", "places"]]],
    ["workbookFunctions:hlookup", [false, ["lookupValue", "tableArray", "rowIndexNum", "rangeLookup"]]],
    ["workbookFunctions:hour", [false, ["serialNumber"]]],
    ["workbookFunctions:hyperlink", [false, ["linkLocation", "friendlyName"]]],
    ["workbookFunctions:hypGeom_Dist", [false, ["sampleS", "numberSample", "populationS", "numberPop", "cumulative"]]],
    ["workbookFunctions:if", [false, ["logicalTest", "valueIfTrue", "valueIfFalse"]]],
    ["workbookFunctions:imAbs", [false, ["inumber"]]],
    ["workbookFunctions:imaginary", [false, ["inumber"]]],
    ["workbookFunctions:imArgument", [false, ["inumber"]]],
    ["workbookFunctions:imConjugate", [false, ["inumber"]]],
    ["workbookFunctions:imCos", [false, ["inumber"]]],
    ["workbookFunctions:imCosh", [false, ["inumber"]]],
    ["workbookFunctions:imCot", [false, ["inumber"]]],
    ["workbookFunctions:imCsc", [false, ["inumber"]]],
    ["workbookFunctions:imCsch", [false, ["inumber"]]],
    ["workbookFunctions:imDiv", [false, ["inumber1", "inumber2"]]],
    ["workbookFunctions:imExp", [false, ["inumber"]]],
    ["workbookFunctions:imLn", [false, ["inumber"]]],
    ["workbookFunctions:imLog10", [false, ["inumber"]]],
    ["workbookFunctions:imLog2", [false, ["inumber"]]],
    ["workbookFunctions:imPower", [false, ["inumber", "number"]]],
    ["workbookFunctions:imProduct", [false, ["values"]]],
    ["workbookFunctions:imReal", [false, ["inumber"]]],
    ["workbookFunctions:imSec", [false, ["inumber"]]],
    ["workbookFunctions:imSech", [false, ["inumber"]]],
    ["workbookFunctions:imSin", [false, ["inumber"]]],
    ["workbookFunctions:imSinh", [false, ["inumber"]]],
    ["workbookFunctions:imSqrt", [false, ["inumber"]]],
    ["workbookFunctions:imSub", [false, ["inumber1", "inumber2"]]],
    ["workbookFunctions:imSum", [false, ["values"]]],
    ["workbookFunctions:imTan", [false, ["inumber"]]],
    ["workbookFunctions:int", [false, ["number"]]],
    ["workbookFunctions:intRate", [false, ["settlement", "maturity", "investment", "redemption", "basis"]]],
    ["workbookFunctions:ipmt", [false, ["rate", "per", "nper", "pv", "fv", "type"]]],
    ["workbookFunctions:irr", [false, ["values", "guess"]]],
    ["workbookFunctions:isErr", [false, ["value"]]],
    ["workbookFunctions:isError", [false, ["value"]]],
    ["workbookFunctions:isEven", [false, ["number"]]],
    ["workbookFunctions:isFormula", [false, ["reference"]]],
    ["workbookFunctions:isLogical", [false, ["value"]]],
    ["workbookFunctions:isNA", [false, ["value"]]],
    ["workbookFunctions:isNonText", [false, ["value"]]],
    ["workbookFunctions:isNumber", [false, ["value"]]],
    ["workbookFunctions:isOdd", [false, ["number"]]],
    ["workbookFunctions:isoWeekNum", [false, ["date"]]],
    ["workbookFunctions:iso_Ceiling", [false, ["number", "significance"]]],
    ["workbookFunctions:ispmt", [false, ["rate", "per", "nper", "pv"]]],
    ["workbookFunctions:isref", [false, ["value"]]],
    ["workbookFunctions:isText", [false, ["value"]]],
    ["workbookFunctions:kurt", [false, ["values"]]],
    ["workbookFunctions:large", [false, ["array", "k"]]],
    ["workbookFunctions:lcm", [false, ["values"]]],
    ["workbookFunctions:left", [false, ["text", "numChars"]]],
    ["workbookFunctions:leftb", [false, ["text", "numBytes"]]],
    ["workbookFunctions:len", [false, ["text"]]],
    ["workbookFunctions:lenb", [false, ["text"]]],
    ["workbookFunctions:ln", [false, ["number"]]],
    ["workbookFunctions:log", [false, ["number", "base"]]],
    ["workbookFunctions:log10", [false, ["number"]]],
    ["workbookFunctions:logNorm_Dist", [false, ["x", "mean", "standardDev", "cumulative"]]],
    ["workbookFunctions:logNorm_Inv", [false, ["probability", "mean", "standardDev"]]],
    ["workbookFunctions:lookup", [false, ["lookupValue", "lookupVector", "resultVector"]]],
    ["workbookFunctions:lower", [false, ["text"]]],
    ["workbookFunctions:match", [false, ["lookupValue", "lookupArray", "matchType"]]],
    ["workbookFunctions:max", [false, ["values"]]],
    ["workbookFunctions:maxA", [false, ["values"]]],
    ["workbookFunctions:mduration", [false, ["settlement", "maturity", "coupon", "yld", "frequency", "basis"]]],
    ["workbookFunctions:median", [false, ["values"]]],
    ["workbookFunctions:mid", [false, ["text", "startNum", "numChars"]]],
    ["workbookFunctions:midb", [false, ["text", "startNum", "numBytes"]]],
    ["workbookFunctions:min", [false, ["values"]]],
    ["workbookFunctions:minA", [false, ["values"]]],
    ["workbookFunctions:minute", [false, ["serialNumber"]]],
    ["workbookFunctions:mirr", [false, ["values", "financeRate", "reinvestRate"]]],
    ["workbookFunctions:mod", [false, ["number", "divisor"]]],
    ["workbookFunctions:month", [false, ["serialNumber"]]],
    ["workbookFunctions:mround", [false, ["number", "multiple"]]],
    ["workbookFunctions:multiNomial", [false, ["values"]]],
    ["workbookFunctions:n", [false, ["value"]]],
    ["workbookFunctions:na", [false, []]],
    ["workbookFunctions:negBinom_Dist", [false, ["numberF", "numberS", "probabilityS", "cumulative"]]],
    ["workbookFunctions:networkDays", [false, ["startDate", "endDate", "holidays"]]],
    ["workbookFunctions:networkDays_Intl", [false, ["startDate", "endDate", "weekend", "holidays"]]],
    ["workbookFunctions:nominal", [false, ["effectRate", "npery"]]],
    ["workbookFunctions:norm_Dist", [false, ["x", "mean", "standardDev", "cumulative"]]],
    ["workbookFunctions:norm_Inv", [false, ["probability", "mean", "standardDev"]]],
    ["workbookFunctions:norm_S_Dist", [false, ["z", "cumulative"]]],
    ["workbookFunctions:norm_S_Inv", [false, ["probability"]]],
    ["workbookFunctions:not", [false, ["logical"]]],
    ["workbookFunctions:now", [false, []]],
    ["workbookFunctions:nper", [false, ["rate", "pmt", "pv", "fv", "type"]]],
    ["workbookFunctions:npv", [false, ["rate", "values"]]],
    ["workbookFunctions:numberValue", [false, ["text", "decimalSeparator", "groupSeparator"]]],
    ["workbookFunctions:oct2Bin", [false, ["number", "places"]]],
    ["workbookFunctions:oct2Dec", [false, ["number"]]],
    ["workbookFunctions:oct2Hex", [false, ["number", "places"]]],
    ["workbookFunctions:odd", [false, ["number"]]],
    ["workbookFunctions:oddFPrice", [false, ["settlement", "maturity", "issue", "firstCoupon", "rate", "yld", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:oddFYield", [false, ["settlement", "maturity", "issue", "firstCoupon", "rate", "pr", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:oddLPrice", [false, ["settlement", "maturity", "lastInterest", "rate", "yld", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:oddLYield", [false, ["settlement", "maturity", "lastInterest", "rate", "pr", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:or", [false, ["values"]]],
    ["workbookFunctions:pduration", [false, ["rate", "pv", "fv"]]],
    ["workbookFunctions:percentile_Exc", [false, ["array", "k"]]],
    ["workbookFunctions:percentile_Inc", [false, ["array", "k"]]],
    ["workbookFunctions:percentRank_Exc", [false, ["array", "x", "significance"]]],
    ["workbookFunctions:percentRank_Inc", [false, ["array", "x", "significance"]]],
    ["workbookFunctions:permut", [false, ["number", "numberChosen"]]],
    ["workbookFunctions:permutationa", [false, ["number", "numberChosen"]]],
    ["workbookFunctions:phi", [false, ["x"]]],
    ["workbookFunctions:pi", [false, []]],
    ["workbookFunctions:pmt", [false, ["rate", "nper", "pv", "fv", "type"]]],
    ["workbookFunctions:poisson_Dist", [false, ["x", "mean", "cumulative"]]],
    ["workbookFunctions:power", [false, ["number", "power"]]],
    ["workbookFunctions:ppmt", [false, ["rate", "per", "nper", "pv", "fv", "type"]]],
    ["workbookFunctions:price", [false, ["settlement", "maturity", "rate", "yld", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:priceDisc", [false, ["settlement", "maturity", "discount", "redemption", "basis"]]],
    ["workbookFunctions:priceMat", [false, ["settlement", "maturity", "issue", "rate", "yld", "basis"]]],
    ["workbookFunctions:product", [false, ["values"]]],
    ["workbookFunctions:proper", [false, ["text"]]],
    ["workbookFunctions:pv", [false, ["rate", "nper", "pmt", "fv", "type"]]],
    ["workbookFunctions:quartile_Exc", [false, ["array", "quart"]]],
    ["workbookFunctions:quartile_Inc", [false, ["array", "quart"]]],
    ["workbookFunctions:quotient", [false, ["numerator", "denominator"]]],
    ["workbookFunctions:radians", [false, ["angle"]]],
    ["workbookFunctions:rand", [false, []]],
    ["workbookFunctions:randBetween", [false, ["bottom", "top"]]],
    ["workbookFunctions:rank_Avg", [false, ["number", "ref", "order"]]],
    ["workbookFunctions:rank_Eq", [false, ["number", "ref", "order"]]],
    ["workbookFunctions:rate", [false, ["nper", "pmt", "pv", "fv", "type", "guess"]]],
    ["workbookFunctions:received", [false, ["settlement", "maturity", "investment", "discount", "basis"]]],
    ["workbookFunctions:replace", [false, ["oldText", "startNum", "numChars", "newText"]]],
    ["workbookFunctions:replaceB", [false, ["oldText", "startNum", "numBytes", "newText"]]],
    ["workbookFunctions:rept", [false, ["text", "numberTimes"]]],
    ["workbookFunctions:right", [false, ["text", "numChars"]]],
    ["workbookFunctions:rightb", [false, ["text", "numBytes"]]],
    ["workbookFunctions:roman", [false, ["number", "form"]]],
    ["workbookFunctions:round", [false, ["number", "numDigits"]]],
    ["workbookFunctions:roundDown", [false, ["number", "numDigits"]]],
    ["workbookFunctions:roundUp", [false, ["number", "numDigits"]]],
    ["workbookFunctions:rows", [false, ["array"]]],
    ["workbookFunctions:rri", [false, ["nper", "pv", "fv"]]],
    ["workbookFunctions:sec", [false, ["number"]]],
    ["workbookFunctions:sech", [false, ["number"]]],
    ["workbookFunctions:second", [false, ["serialNumber"]]],
    ["workbookFunctions:seriesSum", [false, ["x", "n", "m", "coefficients"]]],
    ["workbookFunctions:sheet", [false, ["value"]]],
    ["workbookFunctions:sheets", [false, ["reference"]]],
    ["workbookFunctions:sign", [false, ["number"]]],
    ["workbookFunctions:sin", [false, ["number"]]],
    ["workbookFunctions:sinh", [false, ["number"]]],
    ["workbookFunctions:skew", [false, ["values"]]],
    ["workbookFunctions:skew_p", [false, ["values"]]],
    ["workbookFunctions:sln", [false, ["cost", "salvage", "life"]]],
    ["workbookFunctions:small", [false, ["array", "k"]]],
    ["workbookFunctions:sqrt", [false, ["number"]]],
    ["workbookFunctions:sqrtPi", [false, ["number"]]],
    ["workbookFunctions:standardize", [false, ["x", "mean", "standardDev"]]],
    ["workbookFunctions:stDevA", [false, ["values"]]],
    ["workbookFunctions:stDevPA", [false, ["values"]]],
    ["workbookFunctions:stDev_P", [false, ["values"]]],
    ["workbookFunctions:stDev_S", [false, ["values"]]],
    ["workbookFunctions:substitute", [false, ["text", "oldText", "newText", "instanceNum"]]],
    ["workbookFunctions:subtotal", [false, ["functionNum", "values"]]],
    ["workbookFunctions:sum", [false, ["values"]]],
    ["workbookFunctions:sumIf", [false, ["range", "criteria", "sumRange"]]],
    ["workbookFunctions:sumIfs", [false, ["sumRange", "values"]]],
    ["workbookFunctions:sumSq", [false, ["values"]]],
    ["workbookFunctions:syd", [false, ["cost", "salvage", "life", "per"]]],
    ["workbookFunctions:t", [false, ["value"]]],
    ["workbookFunctions:tan", [false, ["number"]]],
    ["workbookFunctions:tanh", [false, ["number"]]],
    ["workbookFunctions:tbillEq", [false, ["settlement", "maturity", "discount"]]],
    ["workbookFunctions:tbillPrice", [false, ["settlement", "maturity", "discount"]]],
    ["workbookFunctions:tbillYield", [false, ["settlement", "maturity", "pr"]]],
    ["workbookFunctions:text", [false, ["value", "formatText"]]],
    ["workbookFunctions:time", [false, ["hour", "minute", "second"]]],
    ["workbookFunctions:timevalue", [false, ["timeText"]]],
    ["workbookFunctions:today", [false, []]],
    ["workbookFunctions:trim", [false, ["text"]]],
    ["workbookFunctions:trimMean", [false, ["array", "percent"]]],
    ["workbookFunctions:true", [false, []]],
    ["workbookFunctions:trunc", [false, ["number", "numDigits"]]],
    ["workbookFunctions:type", [false, ["value"]]],
    ["workbookFunctions:t_Dist", [false, ["x", "degFreedom", "cumulative"]]],
    ["workbookFunctions:t_Dist_2T", [false, ["x", "degFreedom"]]],
    ["workbookFunctions:t_Dist_RT", [false, ["x", "degFreedom"]]],
    ["workbookFunctions:t_Inv", [false, ["probability", "degFreedom"]]],
    ["workbookFunctions:t_Inv_2T", [false, ["probability", "degFreedom"]]],
    ["workbookFunctions:unichar", [false, ["number"]]],
    ["workbookFunctions:unicode", [false, ["text"]]],
    ["workbookFunctions:upper", [false, ["text"]]],
    ["workbookFunctions:usdollar", [false, ["number", "decimals"]]],
    ["workbookFunctions:value", [false, ["text"]]],
    ["workbookFunctions:varA", [false, ["values"]]],
    ["workbookFunctions:varPA", [false, ["values"]]],
    ["workbookFunctions:var_P", [false, ["values"]]],
    ["workbookFunctions:var_S", [false, ["values"]]],
    ["workbookFunctions:vdb", [false, ["cost", "salvage", "life", "startPeriod", "endPeriod", "factor", "noSwitch"]]],
    ["workbookFunctions:vlookup", [false, ["lookupValue", "tableArray", "colIndexNum", "rangeLookup"]]],
    ["workbookFunctions:weekday", [false, ["serialNumber", "returnType"]]],
    ["workbookFunctions:weekNum", [false, ["serialNumber", "returnType"]]],
    ["workbookFunctions:weibull_Dist", [false, ["x", "alpha", "beta", "cumulative"]]],
    ["workbookFunctions:workDay", [false, ["startDate", "days", "holidays"]]],
    ["workbookFunctions:workDay_Intl", [false, ["startDate", "days", "weekend", "holidays"]]],
    ["workbookFunctions:xirr", [false, ["values", "dates", "guess"]]],
    ["workbookFunctions:xnpv", [false, ["rate", "values", "dates"]]],
    ["workbookFunctions:xor", [false, ["values"]]],
    ["workbookFunctions:year", [false, ["serialNumber"]]],
    ["workbookFunctions:yearFrac", [false, ["startDate", "endDate", "basis"]]],
    ["workbookFunctions:yield", [false, ["settlement", "maturity", "rate", "pr", "redemption", "frequency", "basis"]]],
    ["workbookFunctions:yieldDisc", [false, ["settlement", "maturity", "pr", "redemption", "basis"]]],
    ["workbookFunctions:yieldMat", [false, ["settlement", "maturity", "issue", "rate", "pr", "basis"]]],
    ["workbookFunctions:z_Test", [false, ["array", "x", "sigma"]]],
    ["workbookFilter:apply", [false, ["criteria"]]],
    ["workbookRangeSort:apply", [false, ["fields", "matchCase", "hasHeaders", "orientation", "method"]]],
    ["workbookTableSort:apply", [false, ["fields", "matchCase", "method"]]],
    ["workbookFilter:applyBottomItemsFilter", [false, ["count"]]],
    ["workbookFilter:applyBottomPercentFilter", [false, ["percent"]]],
    ["workbookFilter:applyCellColorFilter", [false, ["color"]]],
    ["workbookFilter:applyCustomFilter", [false, ["criteria1", "criteria2", "oper"]]],
    ["workbookFilter:applyDynamicFilter", [false, ["criteria"]]],
    ["workbookFilter:applyFontColorFilter", [false, ["color"]]],
    ["workbookFilter:applyIconFilter", [false, ["icon"]]],
    ["workbookFilter:applyTopItemsFilter", [false, ["count"]]],
    ["workbookFilter:applyTopPercentFilter", [false, ["percent"]]],
    ["workbookFilter:applyValuesFilter", [false, ["values"]]],
    ["workbookFilter:clear", [false, []]],
    ["workbookTableSort:clear", [false, []]],
    ["workbookChartFill:clear", [false, []]],
    ["workbookChartLineFormat:clear", [false, []]],
    ["workbookRange:clear", [false, ["applyTo"]]],
    ["workbookRangeFill:clear", [false, []]],
    ["workbookTableSort:reapply", [false, []]],
    ["workbookRangeFormat:autofitColumns", [false, []]],
    ["workbookRangeFormat:autofitRows", [false, []]],
    ["workbookApplication:calculate", [false, ["calculationType"]]],
    ["workbookChartFill:setSolidColor", [false, ["color"]]],
    ["workbookRange:delete", [false, ["shift"]]],
    ["workbookRange:insert", [false, ["shift"]]],
    ["workbookRange:merge", [false, ["across"]]],
    ["workbookRange:unmerge", [false, []]],
    ["workbookRange:boundingRect", [true, ["anotherRange"]]],
    ["workbookRange:cell", [true, ["row", "column"]]],
    ["workbookWorksheet:cell", [true, ["row", "column"]]],
    ["workbookRange:column", [true, ["column"]]],
    ["workbookRange:columnsAfter", [true, ["count"]]],
    ["workbookRange:columnsBefore", [true, ["count"]]],
    ["workbookRange:entireColumn", [true, []]],
    ["workbookRange:entireRow", [true, []]],
    ["workbookRange:intersection", [true, ["anotherRange"]]],
    ["workbookRange:lastCell", [true, []]],
    ["workbookRange:lastColumn", [true, []]],
    ["workbookRange:lastRow", [true, []]],
    ["workbookRange:offsetRange", [true, ["rowOffset", "columnOffset"]]],
    ["workbookRange:resizedRange", [true, ["deltaRows", "deltaColumns"]]],
    ["workbookRange:row", [true, ["row"]]],
    ["workbookRange:rowsAbove", [true, ["count"]]],
    ["workbookRange:rowsBelow", [true, ["count"]]],
    ["workbookRange:usedRange", [true, ["valuesOnly"]]],
    ["workbookWorksheet:usedRange", [true, ["valuesOnly"]]],
    ["workbookRange:visibleView", [true, []]],
    ["workbookTable:clearFilters", [false, []]],
    ["workbookTable:convertToRange", [false, []]],
    ["workbookTable:reapplyFilters", [false, []]],
    ["workbookTable:dataBodyRange", [true, []]],
    ["workbookTableColumn:dataBodyRange", [true, []]],
    ["workbookTable:headerRowRange", [true, []]],
    ["workbookTableColumn:headerRowRange", [true, []]],
    ["workbookTable:range", [true, []]],
    ["workbookWorksheet:range", [true, ["address"]]],
    ["workbookTableColumn:range", [true, []]],
    ["workbookNamedItem:range", [true, []]],
    ["workbookRangeView:range", [true, []]],
    ["workbookTableRow:range", [true, []]],
    ["workbookTable:totalRowRange", [true, []]],
    ["workbookTableColumn:totalRowRange", [true, []]],
    ["workbook:sessionInfoResource", [true, ["key"]]],
    ["workbook:tableRowOperationResult", [true, ["key"]]],
    ["workbookWorksheetProtection:protect", [false, ["options"]]],
    ["workbookWorksheetProtection:unprotect", [false, []]],
    ["workbookPivotTable:refresh", [false, []]],
    ["workbookChart:setData", [false, ["sourceData", "seriesBy"]]],
    ["workbookChart:setPosition", [false, ["startCell", "endCell"]]],
    ["workbookChart:image", [true, ["width", "height", "fittingMode"]]],
    ["calendarSharingMessage:accept", [false, []]],
    ["event:accept", [false, ["SendResponse", "Comment"]]],
    ["event:decline", [false, ["ProposedNewTime", "SendResponse", "Comment"]]],
    ["scheduleChangeRequest:decline", [false, ["message"]]],
    ["event:dismissReminder", [false, []]],
    ["event:forward", [false, ["ToRecipients", "Comment"]]],
    ["message:forward", [false, ["ToRecipients", "Message", "Comment"]]],
    ["post:forward", [false, ["Comment", "ToRecipients"]]],
    ["event:snoozeReminder", [false, ["NewReminderTime"]]],
    ["event:tentativelyAccept", [false, ["ProposedNewTime", "SendResponse", "Comment"]]],
    ["mailFolder:copy", [false, ["DestinationId"]]],
    ["message:copy", [false, ["DestinationId"]]],
    ["driveItem:copy", [false, ["name", "parentReference"]]],
    ["mailFolder:move", [false, ["DestinationId"]]],
    ["message:move", [false, ["DestinationId"]]],
    ["message:createForward", [false, ["ToRecipients", "Message", "Comment"]]],
    ["message:createReply", [false, ["Message", "Comment"]]],
    ["message:createReplyAll", [false, ["Message", "Comment"]]],
    ["message:reply", [false, ["Message", "Comment"]]],
    ["post:reply", [false, ["Post"]]],
    ["conversationThread:reply", [false, ["Post"]]],
    ["message:replyAll", [false, ["Message", "Comment"]]],
    ["message:send", [false, []]],
    ["driveItem:createUploadSession", [false, ["item", "deferCommit"]]],
    ["printDocument:createUploadSession", [false, ["properties"]]],
    ["calendar:getSchedule", [false, ["Schedules", "EndTime", "StartTime", "AvailabilityViewInterval"]]],
    ["calendar:allowedCalendarSharingRoles", [true, ["User"]]],
    ["outlookUser:supportedLanguages", [true, []]],
    ["outlookUser:supportedTimeZones", [true, ["TimeZoneStandard"]]],
    ["driveItem:assignSensitivityLabel", [false, ["sensitivityLabelId", "assignmentMethod", "justificationText"]]],
    ["driveItem:checkin", [false, ["checkInAs", "comment"]]],
    ["driveItem:checkout", [false, []]],
    ["driveItem:createLink", [false, ["type", "scope", "expirationDateTime", "password", "message", "retainInheritedPermissions"]]],
    ["driveItem:extractSensitivityLabels", [false, []]],
    ["driveItem:follow", [false, []]],
    ["driveItem:invite", [false, ["requireSignIn", "roles", "sendInvitation", "message", "recipients", "retainInheritedPermissions", "expirationDateTime", "password"]]],
    ["driveItem:permanentDelete", [false, []]],
    ["driveItem:preview", [false, ["page", "zoom"]]],
    ["onenotePage:preview", [true, []]],
    ["driveItem:unfollow", [false, []]],
    ["driveItem:validatePermission", [false, ["challengeToken", "password"]]],
    ["driveItem:getActivitiesByInterval", [true, ["startDateTime", "endDateTime", "interval"]]],
    ["listItem:getActivitiesByInterval", [true, ["startDateTime", "endDateTime", "interval"]]],
    ["site:getActivitiesByInterval", [true, ["startDateTime", "endDateTime", "interval"]]],
    ["driveItem:search", [true, ["q"]]],
    ["drive:search", [true, ["q"]]],
    ["contentType:associateWithHubSites", [false, ["hubSiteUrls", "propagateToExistingLists"]]],
    ["contentType:copyToDefaultContentLocation", [false, ["sourceFile", "destinationFileName"]]],
    ["contentType:isPublished", [true, []]],
    ["permission:grant", [false, ["roles", "recipients"]]],
    ["driveItemVersion:restoreVersion", [false, []]],
    ["listItemVersion:restoreVersion", [false, []]],
    ["site:getApplicableContentTypesForList", [true, ["listId"]]],
    ["site:getByPath", [true, ["path"]]],
    ["drive:recent", [true, []]],
    ["drive:sharedWithMe", [true, []]],
    ["onlineMeeting:getVirtualAppointmentJoinWebUrl", [true, []]],
    ["groupLifecyclePolicy:addGroup", [false, ["groupId"]]],
    ["groupLifecyclePolicy:removeGroup", [false, ["groupId"]]],
    ["synchronization:acquireAccessToken", [false, ["credentials"]]],
    ["directoryDefinition:discover", [false, []]],
    ["synchronizationSchema:parseExpression", [false, ["expression", "testInputObject", "targetAttributeDefinition"]]],
    ["synchronizationSchema:filterOperators", [true, []]],
    ["synchronizationSchema:functions", [true, []]],
    ["synchronizationJob:pause", [false, []]],
    ["synchronizationJob:provisionOnDemand", [false, ["parameters"]]],
    ["synchronizationJob:restart", [false, ["criteria"]]],
    ["synchronizationJob:start", [false, []]],
    ["printJob:start", [false, []]],
    ["synchronizationJob:validateCredentials", [false, ["applicationIdentifier", "templateId", "useSavedCredentials", "credentials"]]],
    ["accessReviewInstance:acceptRecommendations", [false, []]],
    ["accessReviewInstance:applyDecisions", [false, []]],
    ["accessReviewInstance:batchRecordDecisions", [false, ["decision", "justification", "principalId", "resourceId"]]],
    ["accessReviewInstance:resetDecisions", [false, []]],
    ["accessReviewInstance:sendReminder", [false, []]],
    ["accessReviewInstance:stop", [false, []]],
    ["accessReviewScheduleDefinition:stop", [false, []]],
    ["accessReviewStage:stop", [false, []]],
    ["accessReviewHistoryInstance:generateDownloadUri", [false, []]],
    ["accessPackageAssignmentRequest:reprocess", [false, []]],
    ["accessPackageAssignment:reprocess", [false, []]],
    ["accessPackageAssignmentRequest:resume", [false, ["source", "type", "data"]]],
    ["accessPackage:getApplicablePolicyRequirements", [false, []]],
    ["managedDeviceMobileAppConfiguration:assign", [false, ["assignments"]]],
    ["mobileApp:assign", [false, ["mobileAppAssignments"]]],
    ["managedEBook:assign", [false, ["managedEBookAssignments"]]],
    ["deviceCompliancePolicy:assign", [false, ["assignments"]]],
    ["deviceConfiguration:assign", [false, ["assignments"]]],
    ["deviceEnrollmentConfiguration:assign", [false, ["enrollmentConfigurationAssignments"]]],
    ["targetedManagedAppConfiguration:assign", [false, ["assignments"]]],
    ["targetedManagedAppProtection:assign", [false, ["assignments"]]],
    ["windowsInformationProtection:assign", [false, ["assignments"]]],
    ["mobileAppContentFile:commit", [false, ["fileEncryptionInfo"]]],
    ["mobileAppContentFile:renewUpload", [false, []]],
    ["deviceCompliancePolicy:scheduleActionsForRules", [false, ["deviceComplianceScheduledActionForRules"]]],
    ["deviceConfiguration:getOmaSettingPlainTextValue", [true, ["secretReferenceValueId"]]],
    ["reportRoot:deviceConfigurationDeviceActivity", [true, []]],
    ["reportRoot:deviceConfigurationUserActivity", [true, []]],
    ["reportRoot:managedDeviceEnrollmentFailureDetails", [true, ["skip", "top", "filter", "skipToken"]]],
    ["reportRoot:managedDeviceEnrollmentTopFailures", [true, ["period"]]],
    ["reportRoot:getOffice365ActivationCounts", [true, []]],
    ["reportRoot:getOffice365ActivationsUserCounts", [true, []]],
    ["reportRoot:getOffice365ActivationsUserDetail", [true, []]],
    ["reportRoot:getOffice365ActiveUserCounts", [true, ["period"]]],
    ["reportRoot:getOffice365ActiveUserDetail", [true, ["period"]]],
    ["reportRoot:getOffice365GroupsActivityCounts", [true, ["period"]]],
    ["reportRoot:getOffice365GroupsActivityDetail", [true, ["period"]]],
    ["reportRoot:getOffice365GroupsActivityFileCounts", [true, ["period"]]],
    ["reportRoot:getOffice365GroupsActivityGroupCounts", [true, ["period"]]],
    ["reportRoot:getOffice365GroupsActivityStorage", [true, ["period"]]],
    ["reportRoot:getOffice365ServicesUserCounts", [true, ["period"]]],
    ["reportRoot:getOneDriveActivityFileCounts", [true, ["period"]]],
    ["reportRoot:getOneDriveActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getOneDriveActivityUserDetail", [true, ["period"]]],
    ["reportRoot:getOneDriveUsageAccountCounts", [true, ["period"]]],
    ["reportRoot:getOneDriveUsageAccountDetail", [true, ["period"]]],
    ["reportRoot:getOneDriveUsageFileCounts", [true, ["period"]]],
    ["reportRoot:getOneDriveUsageStorage", [true, ["period"]]],
    ["reportRoot:getSharePointActivityFileCounts", [true, ["period"]]],
    ["reportRoot:getSharePointActivityPages", [true, ["period"]]],
    ["reportRoot:getSharePointActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getSharePointActivityUserDetail", [true, ["period"]]],
    ["reportRoot:getSharePointSiteUsageDetail", [true, ["period"]]],
    ["reportRoot:getSharePointSiteUsageFileCounts", [true, ["period"]]],
    ["reportRoot:getSharePointSiteUsagePages", [true, ["period"]]],
    ["reportRoot:getSharePointSiteUsageSiteCounts", [true, ["period"]]],
    ["reportRoot:getSharePointSiteUsageStorage", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessActivityCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessActivityUserDetail", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessDeviceUsageDistributionUserCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessDeviceUsageUserCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessDeviceUsageUserDetail", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessOrganizerActivityCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessOrganizerActivityMinuteCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessOrganizerActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessParticipantActivityCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessParticipantActivityMinuteCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessParticipantActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessPeerToPeerActivityCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessPeerToPeerActivityMinuteCounts", [true, ["period"]]],
    ["reportRoot:getSkypeForBusinessPeerToPeerActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getYammerActivityCounts", [true, ["period"]]],
    ["reportRoot:getYammerActivityUserCounts", [true, ["period"]]],
    ["reportRoot:getYammerActivityUserDetail", [true, ["period"]]],
    ["reportRoot:getYammerDeviceUsageDistributionUserCounts", [true, ["period"]]],
    ["reportRoot:getYammerDeviceUsageUserCounts", [true, ["period"]]],
    ["reportRoot:getYammerDeviceUsageUserDetail", [true, ["period"]]],
    ["reportRoot:getYammerGroupsActivityCounts", [true, ["period"]]],
    ["reportRoot:getYammerGroupsActivityDetail", [true, ["period"]]],
    ["reportRoot:getYammerGroupsActivityGroupCounts", [true, ["period"]]],
    ["reportRoot:getGroupArchivedPrintJobs", [true, ["groupId", "startDateTime", "endDateTime"]]],
    ["reportRoot:getPrinterArchivedPrintJobs", [true, ["printerId", "startDateTime", "endDateTime"]]],
    ["reportRoot:getUserArchivedPrintJobs", [true, ["userId", "startDateTime", "endDateTime"]]],
    ["deviceEnrollmentConfiguration:setPriority", [false, ["priority"]]],
    ["deviceManagementExchangeConnector:sync", [false, ["syncType"]]],
    ["vppToken:syncLicenses", [false, []]],
    ["deviceAppManagement:syncMicrosoftStoreForBusinessApps", [false, []]],
    ["deviceManagementPartner:terminate", [false, []]],
    ["deviceManagement:verifyWindowsEnrollmentAutoDiscovery", [true, ["domainName"]]],
    ["deviceManagement:userExperienceAnalyticsSummarizeWorkFromAnywhereDevices", [true, []]],
    ["deviceManagement:getEffectivePermissions", [true, ["scope"]]],
    ["managedDevice:bypassActivationLock", [false, []]],
    ["managedDevice:cleanWindowsDevice", [false, ["keepUserData"]]],
    ["managedDevice:deleteUserFromSharedAppleDevice", [false, ["userPrincipalName"]]],
    ["managedDevice:disableLostMode", [false, []]],
    ["managedDevice:locateDevice", [false, []]],
    ["managedDevice:logoutSharedAppleDeviceActiveUser", [false, []]],
    ["managedDevice:rebootNow", [false, []]],
    ["managedDevice:recoverPasscode", [false, []]],
    ["managedDevice:remoteLock", [false, []]],
    ["managedDevice:requestRemoteAssistance", [false, []]],
    ["managedDevice:resetPasscode", [false, []]],
    ["managedDevice:retire", [false, []]],
    ["managedDevice:shutDown", [false, []]],
    ["managedDevice:syncDevice", [false, []]],
    ["managedDevice:updateWindowsDeviceAccount", [false, ["updateWindowsDeviceAccountActionParameter"]]],
    ["managedDevice:windowsDefenderScan", [false, ["quickScan"]]],
    ["managedDevice:windowsDefenderUpdateSignatures", [false, []]],
    ["managedDevice:wipe", [false, ["keepEnrollmentData", "keepUserData", "macOsUnlockCode", "persistEsimDataPlan"]]],
    ["appLogCollectionRequest:createDownloadUrl", [false, []]],
    ["deviceLogCollectionResponse:createDownloadUrl", [false, []]],
    ["applePushNotificationCertificate:downloadApplePushNotificationCertificateSigningRequest", [true, []]],
    ["windowsAutopilotDeviceIdentity:assignUserToDevice", [false, ["userPrincipalName", "addressableUserName"]]],
    ["windowsAutopilotDeviceIdentity:unassignUserFromDevice", [false, []]],
    ["windowsAutopilotDeviceIdentity:updateDeviceProperties", [false, ["userPrincipalName", "addressableUserName", "groupTag", "displayName"]]],
    ["targetedManagedAppConfiguration:targetApps", [false, ["apps", "appGroupType"]]],
    ["targetedManagedAppProtection:targetApps", [false, ["apps", "appGroupType"]]],
    ["managedAppPolicy:targetApps", [false, ["apps"]]],
    ["managedAppProtection:targetApps", [false, ["apps"]]],
    ["notificationMessageTemplate:sendTestMessage", [false, []]],
    ["remoteAssistancePartner:beginOnboarding", [false, []]],
    ["remoteAssistancePartner:disconnect", [false, []]],
    ["deviceManagementReports:getCachedReport", [false, ["id", "select", "search", "groupBy", "orderBy", "skip", "top"]]],
    ["deviceManagementReports:getCompliancePolicyNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getCompliancePolicyNonComplianceSummaryReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getComplianceSettingNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getConfigurationPolicyNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getConfigurationPolicyNonComplianceSummaryReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getConfigurationSettingNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getDeviceManagementIntentPerSettingContributingProfiles", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getDeviceManagementIntentSettingsReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getDeviceNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getDevicesWithoutCompliancePolicyReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getHistoricalReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "filter"]]],
    ["deviceManagementReports:getNoncompliantDevicesAndSettingsReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getPolicyNonComplianceMetadata", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getPolicyNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getPolicyNonComplianceSummaryReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getReportFilters", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["deviceManagementReports:getSettingNonComplianceReport", [false, ["name", "select", "search", "groupBy", "orderBy", "skip", "top", "sessionId", "filter"]]],
    ["team:archive", [false, ["shouldSetSpoSiteReadOnlyForMembers"]]],
    ["team:unarchive", [false, []]],
    ["serviceHealthIssue:incidentReport", [true, []]],
    ["searchEntity:query", [false, ["requests"]]],
    ["notebook:copyNotebook", [false, ["groupId", "renameAs", "notebookFolder", "siteCollectionId", "siteId"]]],
    ["onenoteSection:copyToNotebook", [false, ["id", "groupId", "renameAs", "siteCollectionId", "siteId"]]],
    ["onenoteSection:copyToSectionGroup", [false, ["id", "groupId", "renameAs", "siteCollectionId", "siteId"]]],
    ["onenotePage:copyToSection", [false, ["id", "groupId", "siteCollectionId", "siteId"]]],
    ["onenotePage:onenotePatchContent", [false, ["commands"]]],
    ["printJob:abort", [false, ["reason"]]],
    ["printJob:redirect", [false, ["destinationPrinterId", "configuration"]]],
    ["call:redirect", [false, ["targets", "timeout", "callbackUri"]]],
    ["printer:restoreFactoryDefaults", [false, []]],
    ["securityReportsRoot:getAttackSimulationRepeatOffenders", [true, []]],
    ["securityReportsRoot:getAttackSimulationSimulationUserCoverage", [true, []]],
    ["securityReportsRoot:getAttackSimulationTrainingUserCoverage", [true, []]],
    ["call:addLargeGalleryView", [false, ["clientContext"]]],
    ["call:answer", [false, ["callbackUri", "mediaConfig", "acceptedModalities", "participantCapacity", "callOptions"]]],
    ["call:cancelMediaProcessing", [false, ["clientContext"]]],
    ["call:changeScreenSharingRole", [false, ["role"]]],
    ["call:keepAlive", [false, []]],
    ["call:mute", [false, ["clientContext"]]],
    ["participant:mute", [false, ["clientContext"]]],
    ["call:playPrompt", [false, ["prompts", "clientContext"]]],
    ["call:recordResponse", [false, ["prompts", "bargeInAllowed", "initialSilenceTimeoutInSeconds", "maxSilenceTimeoutInSeconds", "maxRecordDurationInSeconds", "playBeep", "stopTones", "clientContext"]]],
    ["call:reject", [false, ["reason", "callbackUri"]]],
    ["call:subscribeToTone", [false, ["clientContext"]]],
    ["call:transfer", [false, ["transferTarget", "transferee"]]],
    ["call:unmute", [false, ["clientContext"]]],
    ["call:updateRecordingStatus", [false, ["status", "clientContext"]]],
    ["presence:clearPresence", [false, ["sessionId"]]],
    ["presence:clearUserPreferredPresence", [false, []]],
    ["presence:setPresence", [false, ["sessionId", "availability", "activity", "expirationDuration"]]],
    ["presence:setStatusMessage", [false, ["statusMessage"]]],
    ["presence:setUserPreferredPresence", [false, ["availability", "activity", "expirationDuration"]]],
    ["cloudCommunications:getPresencesByUserId", [false, ["ids"]]],
    ["participant:startHoldMusic", [false, ["customPrompt", "clientContext"]]],
    ["participant:stopHoldMusic", [false, ["clientContext"]]],
    ["phoneAuthenticationMethod:disableSmsSignIn", [false, []]],
    ["phoneAuthenticationMethod:enableSmsSignIn", [false, []]],
    ["authenticationMethod:resetPassword", [false, ["newPassword"]]],
    ["subscription:reauthorize", [false, []]],
    ["team:clone", [false, ["displayName", "description", "mailNickname", "classification", "visibility", "partsToClone"]]],
    ["team:completeMigration", [false, []]],
    ["channel:completeMigration", [false, []]],
    ["team:sendActivityNotification", [false, ["topic", "activityType", "chainId", "previewText", "templateParameters", "recipient"]]],
    ["chat:sendActivityNotification", [false, ["topic", "activityType", "chainId", "previewText", "templateParameters", "recipient"]]],
    ["userTeamwork:sendActivityNotification", [false, ["topic", "activityType", "chainId", "previewText", "templateParameters"]]],
    ["channel:provisionEmail", [false, []]],
    ["channel:removeEmail", [false, []]],
    ["channel:doesUserHaveAccess", [true, ["userId", "tenantId", "userPrincipalName"]]],
    ["chat:hideForUser", [false, ["user"]]],
    ["chat:markChatReadForUser", [false, ["user"]]],
    ["chat:markChatUnreadForUser", [false, ["user", "lastMessageReadDateTime"]]],
    ["chat:unhideForUser", [false, ["user"]]],
    ["teamwork:sendActivityNotificationToRecipients", [false, ["topic", "activityType", "chainId", "previewText", "teamsAppId", "templateParameters", "recipients"]]],
    ["chatMessage:setReaction", [false, ["reactionType"]]],
    ["chatMessage:softDelete", [false, []]],
    ["chatMessage:undoSoftDelete", [false, []]],
    ["chatMessage:unsetReaction", [false, ["reactionType"]]],
    ["teamsAppInstallation:upgrade", [false, ["consentedPermissionSet"]]],
    ["scheduleChangeRequest:approve", [false, ["message"]]],
    ["schedule:share", [false, ["notifyTeam", "startDateTime", "endDateTime"]]],
]);